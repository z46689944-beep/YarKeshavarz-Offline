...
function addPlan(){
  ...
  card.innerHTML=
    ...
    '<div style="display:flex;gap:14px;flex-wrap:wrap;margin:10px 2px;color:#60736a;font-size:12px">'+
      ...
      '<span>━ مرز زمین</span>'+
      '<span>● مرکز</span>'+
      '<span>مساحت: '+hectare.toLocaleString('fa-IR',{maximumFractionDigits:2})+' هکتار</span>'+ 
      '<span>محیط: '+perimeter.toLocaleString('fa-IR',{maximumFractionDigits:1})+' متر</span>'+ 
    '</div>';

  anchor.parentNode.insertBefore(card,anchor.nextSibling);
}

window.YKLandPlan={addPlan:addPlan,drawPlan:drawPlan};
})();
